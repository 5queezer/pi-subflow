...
- Keep `README.md`, `docs/wiki/`, and `docs/adr/` in sync.
- Treat `docs/wiki/` as the source of truth for GitHub Wiki pages; publish with `npm run wiki:sync` or `npm run wiki:sync:push` instead of editing the GitHub Wiki directly.
