...
- [[Workflow patterns|Workflow-patterns]] — five DAG shapes beyond parallel fan-out (adversarial triangle, two-tier audit, tournament, cross-validation, map-group-reduce), gaps in pure-DAG semantics, and template links.
