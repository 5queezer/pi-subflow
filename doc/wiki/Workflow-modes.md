...
Use `chain` for simple scout → implementer → reviewer handoffs. Use `dag` for named tasks, fan-out/fan-in, parallel dependency stages, verifier synthesis, or graph validation.
